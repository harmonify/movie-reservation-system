...
const (
	AuthService_Auth_FullMethodName = "/harmonify.movie_reservation_system.user.AuthService/Auth"
)
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "harmonify.movie_reservation_system.user.AuthService",
