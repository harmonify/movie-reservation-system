...
import (
	...
	health_rest "github.com/harmonify/movie-reservation-system/movie-search-service/internal/driver/http/health_check"
	movie_rest "github.com/harmonify/movie-reservation-system/movie-search-service/internal/driver/http/movie"
...
var (
	HttpModule = fx.Module(
		...
		fx.Provide(
			...
			movie_rest.NewMovieRestHandler,
			func(p HttpServerParam, cfg *config.MovieSearchServiceConfig) (HttpServerResult, error) {
