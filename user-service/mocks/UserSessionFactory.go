...
func (_m *UserSessionFactory) GenerateUserSession(user *entity.User) (*entity.UserSession, *entityfactory.UserSessionRaw) {
	ret := _m.Called(user)
	...
	if rf, ok := ret.Get(0).(func(*entity.User) (*entity.UserSession, *entityfactory.UserSessionRaw)); ok {
		return rf(user)
	}
...
func (_c *UserSessionFactory_GenerateUserSession_Call) Return(session *entity.UserSession, raw *entityfactory.UserSessionRaw) *UserSessionFactory_GenerateUserSession_Call {
	_c.Call.Return(session, raw)
	return _c
}

func (_c *UserSessionFactory_GenerateUserSession_Call) RunAndReturn(run func(*entity.User) (*entity.UserSession, *entityfactory.UserSessionRaw)) *UserSessionFactory_GenerateUserSession_Call {
	_c.Call.Return(run)
	return _c
}
